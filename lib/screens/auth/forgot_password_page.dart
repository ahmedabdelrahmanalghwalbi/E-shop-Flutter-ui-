...
class _ForgotPasswordPageState extends State<ForgotPasswordPage> with SingleTickerProviderStateMixin{
  ...
  Widget build(BuildContext context) {
    ...
    Widget sendButton = Positioned(
      ...
      child: InkWell(
        onTap: () {
          Navigator.of(context).push(SlideRightTransition(page:ConfirmOtpPage()));
//          Navigator.of(context).push(MaterialPageRoute(builder: (context)=>ConfirmOtpPage()));
        },
        child: Container(
